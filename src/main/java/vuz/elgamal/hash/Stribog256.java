...
import vuz.elgamal.hash.constants.Data;
import vuz.elgamal.hash.exceptions.InvalidVectorLenException;

import java.util.ArrayList;
import java.util.Arrays;
import java.util.List;

public class Stribog256 {

    public static final int[] IV = new int[64];

    private final List<Integer> buffer = new ArrayList<>(256);
